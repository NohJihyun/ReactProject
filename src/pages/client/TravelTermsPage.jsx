...
const CANCEL_DOMESTIC = [
    ...
    { timing: '출발 20일 전까지 취소', fee: '여행요금의 10%' },
    { timing: '출발 10일 전까지 취소', fee: '여행요금의 15%' },
    { timing: '출발 8일 전까지 취소', fee: '여행요금의 20%' },
    { timing: '출발 1일 전까지 취소', fee: '여행요금의 30%' },
    { timing: '출발 당일 취소 또는 여행 중도 포기', fee: '여행요금의 50%' },
];
