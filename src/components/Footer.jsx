                ...
                >
                    ...
                    <Box>
                        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 2 }}>
                            <Typography variant="body2" fontWeight={700} sx={{ color: '#fff', letterSpacing: 0.5 }}>
                                고객센터
                            </Typography>
                            <Stack direction="row" spacing={1}>
                                ...
                                >
                                    <Box component="svg" viewBox="0 0 24 24" sx={{ width: 18, height: 18, fill: 'url(#igGradFooter)', flexShrink: 0 }}>
                                        <defs>
